...
const TRANSLATIONS = {
  en: {
    ...
    hero_subtitle: "Crafting visually stunning, user-centered interfaces backed by behavioral research and business logic.",
    ...
    metric_1_num: "50+",
    metric_1_title: "Digital Products Shipped",
    metric_1_desc: "Designing complete, launch-ready visual systems and high-fidelity mockups from the ground up.",
    metric_2_num: "100%",
    metric_2_title: "Pixel-Perfect Precision",
    metric_2_desc: "Creating responsive layouts, micro-interactions, and detailed components where every pixel matters.",
    metric_3_num: "5+",
    metric_3_title: "Years Designing Products",
    metric_3_desc: "Partnering with ambitious startups and founders to turn complex ideas into clean, user-friendly digital designs.",
  ...
  es: {
    ...
    hero_subtitle: "Creando interfaces visualmente impresionantes y centradas en el usuario, respaldadas por investigación de comportamiento y lógica de negocio.",
    ...
    metric_1_num: "50+",
    metric_1_title: "Productos Digitales Lanzados",
    metric_1_desc: "Diseñando sistemas visuales completos y prototipos de alta fidelidad listos para el lanzamiento.",
    metric_2_num: "100%",
    metric_2_title: "Precisión de Pixel Perfecto",
    metric_2_desc: "Creando interfaces adaptables, microinteracciones y componentes detallados donde cada píxel cuenta.",
    metric_3_num: "5+",
    metric_3_title: "Años Diseñando Productos",
    metric_3_desc: "Colaborando con startups y fundadores ambiciosos para transformar ideas complejas en diseños simples y amigables.",
