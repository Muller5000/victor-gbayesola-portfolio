...
const TRANSLATIONS = {
  en: {
    ...
    hero_title: "Designing premium digital products that <span class='accent-gradient'>connect, inspire, and scale</span>.",
    hero_subtitle: "I design clean, high-performance interfaces that bridge the gap between user behavior and business logic.",
    hero_location: "📍 Lagos, Nigeria — Global Delivery",
    hero_focus: "⚡ Aesthetics Backed by Research",
    ...
    about_econ_desc: "Using user research, behavioral economics, and data metrics to validate and guide creative design decisions.",
    about_ent_title: "Venture Growth Strategy",
    about_ent_desc: "Designing investor pitch decks, aligning startup brand systems, and scoping visual MVPs for venture growth.",
    ...
    role_1_desc: "Designing high-fidelity mobile and web interfaces, building cohesive design systems, and structuring startup pitch decks for venture funding.",
    role_2_desc: "Bridging quantitative user data and behavioral trends with UI components to improve dashboard usability and task completion rates by 42%.",
    role_3_desc: "Designing visual mockups, wireframing user journeys, and creating interactive prototypes for early-stage digital products.",
    
    contact_subtitle: "Get In Touch",
    contact_title: "Initiate a Collaboration",
    contact_desc: "Looking to design a new product, establish a visual design system, or discuss user experiences? Leave a message below.",
    ...
    metrics_tagline: "Designing premium, high-fidelity digital interfaces that connect with users and scale brands.",
    metric_1_num: "50+",
    metric_1_title: "Products Shipped",
    metric_1_desc: "Designing complete visual systems and launch-ready interactive prototypes from concept to production.",
    metric_2_num: "100%",
    metric_2_title: "Design Precision",
    metric_2_desc: "Creating layout hierarchies, smooth micro-interactions, and detailed components where every pixel matters.",
    metric_3_num: "5+",
  ...
  es: {
    ...
    hero_title: "Diseñando productos digitales premium que <span class='accent-gradient'>conectan, inspiran y escalan</span>.",
    hero_subtitle: "Diseño interfaces limpias y de alto rendimiento que conectan el comportamiento del usuario con la lógica de negocio.",
    hero_location: "📍 Lagos, Nigeria — Entrega Global",
    hero_focus: "⚡ Estética Respaldada por Investigación",
    ...
    about_econ_desc: "Utilizando investigación de usuarios, economía del comportamiento y métricas de datos para validar y guiar las decisiones de diseño.",
    about_ent_title: "Estrategia de Startups",
    about_ent_desc: "Diseñando pitch decks para inversores, alineando marcas de startups y estructurando MVPs visuales para el crecimiento del negocio.",
    ...
    role_1_desc: "Diseñando interfaces web y móviles de alta fidelidad, construyendo sistemas de diseño y estructurando pitch decks para financiación.",
    role_2_desc: "Conectando datos de usuarios y tendencias de comportamiento con componentes de UI para mejorar la usabilidad del panel en un 42%.",
    role_3_desc: "Diseñando maquetas visuales, estructurando flujos de usuarios y creando prototipos interactivos para productos digitales.",
    
    contact_subtitle: "Contacto",
    contact_title: "Iniciar una Colaboración",
    contact_desc: "¿Buscas diseñar un nuevo producto, establecer un sistema de diseño visual o hablar de experiencia de usuario? Deja un mensaje abajo.",
    ...
    metrics_tagline: "Diseñando interfaces digitales premium de alta fidelidad que conectan con los usuarios y escalan marcas.",
    metric_1_num: "50+",
    metric_1_title: "Productos Lanzados",
    metric_1_desc: "Diseñando sistemas visuales completos y prototipos interactivos listos para producción desde el concepto.",
    metric_2_num: "100%",
    metric_2_title: "Precisión de Diseño",
    metric_2_desc: "Creando jerarquías de diseño, microinteracciones fluidas y componentes detallados donde cada píxel cuenta.",
    metric_3_num: "5+",
